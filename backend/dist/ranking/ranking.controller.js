...
let RankingController = class RankingController {
    ...
    getRanking(competitionId, user) {
        return this.rankingService.getRanking(competitionId, user.sub, user.role);
    }
    getDetails(competitionId, userId, currentUser) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], RankingController.prototype, "getDetails", null);
exports.RankingController = RankingController = __decorate([
    (0, swagger_1.ApiTags)('ranking'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.Controller)('competitions/:competitionId/ranking'),
